...
class TestCalculator(unittest.TestCase):
    ...
    def test_process_input(self):
        ...
        result = "0.2×0.8"
        for value in values:
            self.calc.display_frame.process_input(value)
        self.assertEqual(self.calc.display_frame.display.get(), result)

    def test_invalid_inputs(self):
        """Test the input functionality for invalid keyboard presses."""
        values = "abcdefghijklmnopqrstuvwxyz"
        for value in values:
            self.calc.display_frame.process_input(value) # Invalid input
            self.assertEqual(self.calc.display_frame.display.get(), "0")  # It should remain 0
            
    def test_clear_display(self):
        """Test the clear display functionality."""
        self.calc.display_frame.process_input("45678")  # Valid input numbers
        self.calc.display_frame.process_input("\x1b")  # C or the ESC key press
        self.assertEqual(self.calc.display_frame.display.get(), "0")
    ...
    def test_backspace_function(self):
        ...
        self.calc.display_frame.process_input("12")
        for backspace in backspaces:
            self.calc.display_frame.process_input(backspace)
        self.assertEqual(self.calc.display_frame.display.get(), "0")
